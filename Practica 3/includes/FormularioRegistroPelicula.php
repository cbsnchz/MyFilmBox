...
class FormularioRegistroPelicula extends Form
{
    ...
    protected function procesaFormulario($datos)
    {
		...
		$clasePelicula = clasePelicula::crea($titulo, $anyo, $duracion,$director, $origen, $calificacion, $reparto,  $productora, $genero, $sinopsis);
        if(!$clasePelicula) echo 'No se ha podido crear la pelicula';
        return 'index.php';
    }
}